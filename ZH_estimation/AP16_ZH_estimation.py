...
# =========================
# Load Apollo 16 Data
#file_path = "D:/Sat_MV/APollo16_0427.csv"
file_path = "D:/Sat_MV/APollo16_0527.csv"
#file_path = "D:\Sat_MV\Apollo16_0331\Apollo16_05270528.csv"
...
fs = 1/60     # New sampling frequency after resampling
dt = 1 / fs  # Sampling interval
Coh_threshold = 0.4  # Coherence threshold
...
# =========================
n_segments = 6  # Desired number of time windows
...
# Compute C-response
#Theta12 = np.radians(134.02)  #for0427
Theta12 = np.radians(129.54)  #for0527
...
plt.title('Apollo 16 C-response with Error (Welch’s Method)')
plt.legend()
plt.grid()
plt.show()
...
plt.title('Apollo 16 Apparent Resistivity with Error')
plt.grid()
plt.show()
...
plt.title('Apollo 16 Phase with Error')
plt.grid()
plt.show()
...
save_c_response_results(
    base_filename="Apollo16_results",
